...
fn schilling_data(line_items: Vec<InvoiceLineItem>, invoice_type: InvoiceType) -> InvoiceData {
    InvoiceData {
        ...
        customer_email: Some("schilling@example.de".into()),
        company_name: None,
        attention_line: None,
        billing_street: "Schlickumerstr. 15A".into(),
        billing_city: "31157 Sarstedt".into(),
        service_street: "Schlickumerstr. 15A".into(),
        service_city: "31157 Sarstedt".into(),
...
async fn preview_5_business_customer_invoice() {
    ...
    let data = InvoiceData {
        ...
        customer_email: Some("karge@example.de".into()),
