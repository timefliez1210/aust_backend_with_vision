...
fn preview_offer_pdf() {
    let data = OfferData {
        ...
        line_items: vec![
            OfferLineItem { description: "4 Umzugshelfer".to_string(), quantity: 4.0, unit_price: 30.0, is_labor: true, remark: None, flat_total: None },
            OfferLineItem { description: "De/Montage".to_string(), quantity: 1.0, unit_price: 50.0, is_labor: false, remark: None, flat_total: None },
            OfferLineItem { description: "Halteverbotszone".to_string(), quantity: 2.0, unit_price: 100.0, is_labor: false, remark: Some("Beladestelle + Entladestelle".to_string()), flat_total: None },
            OfferLineItem { description: "Umzugsmaterial".to_string(), quantity: 1.0, unit_price: 30.0, is_labor: false, remark: Some("inkl. Einpackservice".to_string()), flat_total: None },
            OfferLineItem { description: "3,5t Transporter".to_string(), quantity: 1.0, unit_price: 60.0, is_labor: false, remark: Some("m. Koffer".to_string()), flat_total: None },
            OfferLineItem { description: "Anfahrt/Abfahrt".to_string(), quantity: 1.0, unit_price: 51.29, is_labor: false, remark: None, flat_total: None },
        ],
        detected_items: vec![
